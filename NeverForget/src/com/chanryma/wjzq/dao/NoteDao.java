...
public class NoteDao {
    ...
    public Note queryWithNoteId(final int noteId) {
        String sql = "SELECT `id`, `parentId`, `createdOn`, `createdBy`, `memo`, `lockTime`, `address`, `longitude`, `latitude` FROM `note` where id = ?;";

        return jdbcTemplate.queryOne(sql, new JDBCCallback<Note>() {
